 ...
 * @description:
 */
public class MultipleStatusFrameLayout extends FrameLayout implements OnGenerateStatusViewCallback, IMultipleStatusView {

    private MultipleStatusDelegate mMultipleStatusDelegate;

    public MultipleStatusFrameLayout(Context context) {
        this(context, null);
    }

    public MultipleStatusFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public MultipleStatusFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
